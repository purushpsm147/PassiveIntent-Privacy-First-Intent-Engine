    ...
    <>
      <div className="demo-header">
        ...
        <p className="demo-description">
          ...
          Use it to correlate behavioral signals with revenue outcomes — entirely in-browser, fully
      ...
      <div className="card">
        ...
        <div className="input-row" style={{ flexWrap: 'wrap', gap: 12 }}>
          ...
          <div>
            ...
            <input type="text" value={currency} onChange={e => setCurrency(e.target.value)} style={{ minWidth: 0, width: 80 }} />
          </div>
        </div>
        <div style={{ marginTop: 14 }}>
          <button className="btn btn-primary" onClick={handleTrack}>💰 Track Conversion</button>
        </div>
      </div>
      ...
      {history.length > 0 && (
        <div className="card">
          ...
          <table className="data-table">
            <thead><tr><th>Type</th><th>Value</th><th>Currency</th></tr></thead>
            <tbody>
              {history.map((c, i) => (
                <tr key={i}>
                  <td><code style={{ fontFamily: 'var(--font-mono)', color: 'var(--green)' }}>{c.type}</code></td>
